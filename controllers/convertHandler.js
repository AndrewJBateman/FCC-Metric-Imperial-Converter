 ...
 *
 */
const unitArray = ['lbs', 'kg', 'gal', 'l', 'mi', 'km'],
	convUnitArray = {
		lbs: 'kg',
		gal: 'l',
		mi: 'km',
...
function ConvertHandler() {
	...
	// remove numbers using regex then check if unit exists in the unitArray
	...
	// return converted unit using a simple 2D array
	this.getReturnUnit = function (initUnit) {
		var result;
		let initUnitLower = initUnit.toLowerCase();
		return (result =
			initUnit !== 'invalid' ? convUnitArray[initUnitLower] : 'invalid unit');
	};

	// return full name of unit based unit input
	...
	this.getString = function (initNum, initUnit, returnNum, returnUnit) {
		var result;
		let roundedNum = +returnNum.toFixed(2);
